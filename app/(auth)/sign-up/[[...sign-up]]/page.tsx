        ...
        <div className="min-h-screen grid w-full items-center bg-zinc-900 px-4 font-mono text-sm text-white">
            <SignUp.Root>
                ...
                >
                    ...
                    <SignUp.Action submit className="w-full px-4 py-2 bg-yellow-400 border-2 border-black shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:shadow-none text-black font-bold uppercase font-game">
                        Sign Up
                    </SignUp.Action>

                    <p className="text-center text-xs text-yellow-400 font-game">
                        Already have an account?{' '}
                        <Clerk.Link navigate="sign-in" className="font-bold underline underline-offset-2 hover:text-yellow-200 font-game">
                            Sign in
                        </Clerk.Link>
                    </p>
                </SignUp.Step>
